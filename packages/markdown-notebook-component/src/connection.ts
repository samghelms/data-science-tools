...
import {
    ...
    Trace, Tracer, CancellationToken, MessageConnection, Disposable
} from 'vscode-jsonrpc';
...
export function createConnection(connection: MessageConnection, errorHandler: ConnectionErrorHandler, closeHandler: ConnectionCloseHandler, cellManager: CellsManager): IConnection {
